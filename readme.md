...
```
curl https://get.ignite.com/CloutContracts/Side-EVM@latest! | sudo bash
```
`username/ccs2` should match the `username` and `repo_name` of the Github repository to which the source code was pushed. Learn more about [the install process](https://github.com/allinbits/starport-installer).
